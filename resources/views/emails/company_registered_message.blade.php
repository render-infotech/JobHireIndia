                            ...
                            <tr>
                                <td class="subtitle" style="font-family:Helvetica, Arial, sans-serif;font-size:14px;line-height:22px;font-weight:400;color:#333;padding-bottom:30px; text-align: left;">
                                    ...
                                    <p>
                                        <br>
                                        Front link :                                      
                                            <a href="{{ $link }}" style="color: #fff;text-decoration: none;background: #000; padding: 7px 10px;text-align: center;display: inline-block;margin-top: 20px;">{{ $link }}</a>
                                        ...
                                        Admin link : 
                                            ...
                                            <a href="{{ $link_admin }}" style="color: #fff;text-decoration: none;background: #900; padding: 7px 10px;text-align: center;display: inline-block;margin-top:10px;">{{ $link_admin }}</a>
