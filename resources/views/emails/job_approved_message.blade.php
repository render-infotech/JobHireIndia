...
<p><strong>Job Link:</strong> <br>
<a href="{{ $link }}" style="color: #fff;text-decoration: none;background:rgb(87, 64, 189); padding: 7px 10px;text-align: center;display: inline-block;margin-top: 20px;">Click here to View Job</a>
    <br>
</p>
