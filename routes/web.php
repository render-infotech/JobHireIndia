...
Route::get('/for-employers', function () {
  return view('for_employers');
});
Route::get('/for-jobseekers', function () {
  return view('for_jobseekers');
});
...
Route::middleware('guest')->group(function () {
  Route::post('candidate/send-otp', 'Auth\LoginController@sendCandidateOtp')
    ->name('candidate.otp.send');

  Route::post('candidate/verify-otp', 'Auth\LoginController@verifyCandidateOtp')
    ->name('candidate.otp.verify');
});
