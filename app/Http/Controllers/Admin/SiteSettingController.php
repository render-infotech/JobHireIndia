...

{
...

    {
        ...
        // Iyzico fields
        // $siteSetting->iyzico_api_key = $request->input('iyzico_api_key');
        // $siteSetting->iyzico_secret_key = $request->input('iyzico_secret_key');
        // $siteSetting->iyzico_live_sandbox = $request->input('iyzico_live_sandbox');
        // $siteSetting->is_iyzico_active = $request->input('is_iyzico_active');
